...
cursor.execute('''INSERT INTO Students (FirstName, LastName, Age, Grade) VALUES ( 'John', 'Doe', 19,
85.5)''')
cursor.execute('''INSERT INTO Students (FirstName, LastName, Age, Grade) VALUES ( 'Jane', 'Smith', 20,
90.0)''')
cursor.execute('''INSERT INTO Students (FirstName, LastName, Age, Grade) VALUES ( 'Bob', 'Biggs', 22,
75.0)''')
cursor.execute('''INSERT INTO Students (FirstName, LastName, Age, Grade) VALUES ( 'Jim', 'Brown', 21,
78.5)''')
cursor.execute('''INSERT INTO Students (FirstName, LastName, Age, Grade) VALUES ( 'Suzy', 'Smith', 18,
80.0)''')
cursor.execute('''INSERT INTO Students (FirstName, LastName, Age, Grade) VALUES ( 'Sam', 'Smith', 19,
92.5)''')
